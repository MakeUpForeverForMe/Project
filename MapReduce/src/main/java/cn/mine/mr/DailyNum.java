...
public class DailyNum extends Configured implements Tool {
    public static class DailyNumMap extends Mapper<LongWritable, Text, Text, Text> {
        @Override
    ...
    public static class DailyNumReduce extends Reducer<Text, Text, Text, LongWritable> {
        @Override
