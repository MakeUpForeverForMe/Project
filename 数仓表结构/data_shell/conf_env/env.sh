...
case $ip in
  (10.80.* ) hive_host=node233:10000 impala_host=node168 is_test=n ;;
  (10.83.* ) hive_host=node123:10000 impala_host=node47  is_test=y ;;
esac
...
beeline="beeline -n hive -u 'jdbc:hive2://$hive_host'"
impala="impala-shell -u hive -i $impala_host:21000"
