...
set hive.exec.max.dynamic.partitions=700000;
set hive.exec.max.dynamic.partitions.pernode=100000;
 



insert overwrite table dw${db_suffix}.dw_loan_base_stat_overdue_num_day partition(biz_date,product_id)
select
...
from ( -- 借据主表
  ...
  from ( -- 主表，正常取数据
    ...
    where 1 > 0
      ...
      ${hive_param_str}
      -- and due_bill_no in ('1120061617084990237722','1120061611511521470455')
  ...
  left join ( -- 判断当前逾期天数是否是第一期出现
    ...
    -- order by product_id,due_bill_no,overdue_days
