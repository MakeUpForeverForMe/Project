--create table if not exists dw.dw_user_information_stat_d(
...
sum(nvl(user_hash_loan_info.paid_amount,0))                                                                                          as paid_amount,
sum(nvl(user_hash_loan_info.paid_principal,0))                                                                                       as paid_principal,
sum(nvl(user_hash_loan_info.paid_interest,0))                                                                                        as paid_interest,
sum(nvl(user_hash_loan_info.paid_penalty,0))                                                                                         as paid_penalty,
sum(nvl(user_hash_loan_info.paid_svc_fee,0))                                                                                         as paid_svc_fee,
...
(
    select
        ...
        due_bill_no
    from
    ods.loan_apply  where biz_date<='${ST9}' 
...
(
    ...
    from
    ods.loan_apply  where biz_date<='${ST9}' and  product_id in (${product_id_list})
