...
select
  ...
  today.account_age                                   as account_age,
  ...
  nvl(today.remain_othAmounts,0)                      as remain_othAmounts,
  ...
  today.dpd_days_max                                  as dpd_days_max,
  today.overdue_term                                  as overdue_term,
  today.overdue_terms_count                           as overdue_terms_count,
  today.overdue_terms_max                             as overdue_terms_max,
  today.overdue_principal_accumulate                  as overdue_principal_accumulate,
  today.overdue_principal_max                         as overdue_principal_max,
