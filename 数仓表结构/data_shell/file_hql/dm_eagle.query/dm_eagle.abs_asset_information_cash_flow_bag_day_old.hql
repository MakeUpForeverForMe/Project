...
set hivevar:ST9=current_date();

insert overwrite table dm_eagle.abs_asset_information_cash_flow_bag_day_old partition(bag_id)
-- 单个包维度
select
  ...
  biz_dates.collect_date                       as biz_date,
