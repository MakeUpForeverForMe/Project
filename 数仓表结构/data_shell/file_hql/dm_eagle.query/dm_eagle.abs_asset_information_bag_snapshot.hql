...
insert overwrite table dm_eagle.abs_asset_information_bag_snapshot partition(bag_id)
select
...
on  bag_info.bag_date   = dw_abs.biz_date
and bag_due.project_id  = dw_abs.project_id
and bag_due.due_bill_no = dw_abs.due_bill_no_join
group by dw_abs.project_id,bag_due.bag_id
-- limit 10
;
