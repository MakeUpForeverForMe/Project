...
select 
 ...
 is_confirmed,
 online_flag
from stage.repay_trans_flow where batch_date='${ST9}' and p_type='WS0013200001'  
...
left join 
(select max(term) term,product_no,due_bill_no,flow_sn from stage.${tb_prefix}receipt_detail where d_date<='${ST9}' and p_type='WS0013200001'
...
select 
 ...
 created_date,
 last_modified_date
from stage.loan_trans_flow where batch_date='${ST9}' and p_type='WS0013200001') a 
left join 
(select * from 
(select 
*,
