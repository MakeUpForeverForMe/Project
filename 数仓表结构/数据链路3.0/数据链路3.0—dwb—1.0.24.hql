...
CREATE TABLE IF NOT EXISTS `dwb.dwb_repay_hst`(
  ...
  `due_bill_no`                   string        COMMENT '借据号',
  `bnp_type`                      string        COMMENT '余额成分（Pricinpal：本金，Interest：利息，Penalty：罚息，Mulct：罚金，Compound：复利，CardFee：年费，OverLimitFee：超限费，LatePaymentCharge：滞纳金，NSFCharge：资金不足罚金，TXNFee：交易费，TERMFee：手续费，SVCFee：服务费）',
